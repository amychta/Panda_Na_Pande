#!/usr/bin/env python
# -*- coding: utf-8 -*-
#  Оці перші дві строчки потрібні, якщо у вас встановлений Python версії 2.7, який не розуміє українських літер
import pygame
...
class Panda:
    ...
    def change_skin_if_another_panda_is_near(self, other_panda):
        is_near = self.rectangle.colliderect(other_panda.rectangle) #  colliderect - це вбудована функція бібліотеки pygame
                                                                    #  вона перевіряє, що прямокутники навколо двох панд
                                                                    # накладаються один на інший
        if is_near:
