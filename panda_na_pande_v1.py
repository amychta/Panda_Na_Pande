#!/usr/bin/env python
# -*- coding: utf-8 -*-
#  Оці перші дві строчки потрібні у тому випадку, якщо у вас встановлений Python версії 2 (2.7), а не версії 3 (3.7)
import pygame

##########   Тут приклад того, як імпортувати бібліотеку випадкових чисел:
# import random
##########   і тут приклад- як використовувати:
# i = random.randint(0, 5)

##########   Тут можна дізнатися координати верхньої лівої точки панди
# self.rectangle.x    або   panda1.rectangle.x   (координата по ширині - приймає значення від 0 до 1000)
# self.rectangle.y    або   panda1.rectangle.y   (координата по висоті - приймає значення від 0 до 800)
# верхня ліва точка вікна має координати: 0, 0
# нижня права точка вікна має координати: 1000, 800   (дивись константу WINDOW_SIZE)
